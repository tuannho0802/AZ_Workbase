...
| `customers.edit` | customers | Sửa thông tin KH — **đồng thời gate luôn 2 sub-resource**: `POST /customers/:id/deposits` (nạp tiền) và `PATCH /customers/:id/group-memberships/:groupId` (tick "đã join nhóm") |
